...
#include "globals.hh"
#include "OpModelPhysicsList.hh"
#include "OpModelPhysicsListMessenger.hh"
...
// Added so can include units in cuts values, JB 07/11/17
#include "G4SystemOfUnits.hh"

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

OpModelPhysicsList::OpModelPhysicsList() 
 : G4VUserPhysicsList(),
   fVerboseLebel(1), fMaxNumPhotonStep(20)
{
  fMessenger = new OpModelPhysicsListMessenger(this);
  defaultCutValue = 1.0*mm; // Added, JB 07/11/17. Note that changing this messes everything up.
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

OpModelPhysicsList::~OpModelPhysicsList() { delete fMessenger; }

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void OpModelPhysicsList::ConstructParticle()
{
...
void OpModelPhysicsList::ConstructProcess()
{
  AddTransportation();
  ConstructDecay();
  ConstructEM();
...
void OpModelPhysicsList::ConstructDecay()
{
  // Add Decay Process
...
void OpModelPhysicsList::ConstructOp()
{
  ...
  while( (*theParticleIterator)() ){
    ...
    if (particleName == "opticalphoton") {
      ...
      pmanager->AddDiscreteProcess(absorptionProcess);
			pmanager->AddDiscreteProcess(rayleighScatteringProcess); // Added 06/11/17, JB
...
void OpModelPhysicsList::SetVerbose(G4int verbose)
{
...
void OpModelPhysicsList::SetNbOfPhotonsCerenkov(G4int MaxNumber)
{
...
void OpModelPhysicsList::SetCuts()
{
